...
```
$ docker image tag ui dakshi/ui
$ docker push dakshi/ui
$ docker image tag organization dakshi/organization
$ docker push dakshi/organization
$ docker image tag leave dakshi/leave
$ docker push dakshi/leave
$ docker image tag meeting dakshi/meeting
$ docker push dakshi/meeting
$ docker image tag notification dakshi/notification
$ docker push dakshi/notification
```
